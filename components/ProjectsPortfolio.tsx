      ...
      <section className="relative">
        <header className="flex flex-wrap items-end justify-between gap-3 border-b border-white/10 pb-3 sm:pb-4">
          <div className="flex items-center gap-3">
            <span
              className={cn(
                "flex size-10 items-center justify-center rounded-xl ring-1 sm:size-11",
                isOngoing
            ...
            <div>
              ...
              <h3 className="text-display mt-1 text-balance text-xl font-semibold leading-tight text-white sm:text-3xl">
                {category.label}
              </h3>
            </div>
          </div>
        ...
        <p className="mt-2 max-w-3xl text-[13.5px] leading-relaxed text-silver/95 sm:mt-3 sm:text-[14px]">
          {category.blurb}
        </p>

        <ul className="mt-4 grid gap-2.5 sm:mt-6 sm:grid-cols-2 lg:grid-cols-3">
